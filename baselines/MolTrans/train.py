...
def main():
    ...
    dataFolder = f'./dataset/{args.task}'
    ...
    for epo in range(args.epochs):
        ...
        with torch.set_grad_enabled(False):
            ...
            if auc > max_auc:
                ...
                max_auc = auc
                # MODEL SAVE LOGIC
                torch.save(model_max.state_dict(), 'best_moltrans_model.pt')
                print(f'[*] Saved new best model to disk with AUC: {max_auc:.4f}')
