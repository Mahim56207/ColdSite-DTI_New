...
1 of 16 cells survive correction at alpha = 0.05.

- `hyperattentiondti|davis|random` p=0.001996 (threshold 0.003125) -> yes
- `coldsite_dti|davis|cold_drug` p=0.005988 (threshold 0.003333) -> no
- `moltrans|davis|cold_target` p=0.01198 (threshold 0.003571) -> no
- `moltrans|davis|cold_drug` p=0.01996 (threshold 0.003846) -> no
- `hyperattentiondti|davis|cold_drug` p=0.0499 (threshold 0.004167) -> no
- `hyperattentiondti|davis|cold_target` p=0.1078 (threshold 0.004545) -> no
- `moltrans|davis|cold_pair` p=0.2116 (threshold 0.005) -> no
- `hyperattentiondti|davis|cold_pair` p=0.3014 (threshold 0.005556) -> no
- `uniform_control|davis|cold_drug` p=0.4311 (threshold 0.00625) -> no
- `moltrans|davis|random` p=0.479 (threshold 0.007143) -> no
