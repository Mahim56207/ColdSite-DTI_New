# Kinase confound control — hyperattentiondti, kiba, seed 1
...
|---|---|---|---|---|---|
| random | 0.018 | 0.013 | +0.005 | 211 | 60 |
| cold_drug | 0.025 | 0.018 | +0.007 | 212 | 60 |
...
- `cold_target` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_target_binary_seed1_hyperattentiondti.pt
- `cold_pair` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_pair_binary_seed1_hyperattentiondti.pt