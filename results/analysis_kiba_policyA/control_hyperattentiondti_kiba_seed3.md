# Kinase confound control — hyperattentiondti, kiba, seed 3
...
|---|---|---|---|---|---|
| random | 0.055* | 0.015 | +0.040 | 211 | 60 |
| cold_drug | 0.026 | 0.012 | +0.014 | 212 | 60 |
...
- `cold_target` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_target_binary_seed3_hyperattentiondti.pt
- `cold_pair` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_pair_binary_seed3_hyperattentiondti.pt