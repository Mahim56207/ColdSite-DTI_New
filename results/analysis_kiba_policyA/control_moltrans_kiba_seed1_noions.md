# Kinase confound control — moltrans, kiba, seed 1
...
|---|---|---|---|---|---|
| random | 0.021 | 0.005 | +0.016 | 211 | 60 |
| cold_drug | 0.028 | 0.015 | +0.013 | 212 | 60 |
...
- `cold_target` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_target_binary_seed1_moltrans.pt
- `cold_pair` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_pair_binary_seed1_moltrans.pt