# Kinase confound control — moltrans, kiba, seed 2
...
|---|---|---|---|---|---|
| random | 0.053* | 0.013 | +0.040 | 211 | 60 |
| cold_drug | 0.063* | 0.015 | +0.048 | 212 | 60 |
...
- `cold_target` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_target_binary_seed2_moltrans.pt
- `cold_pair` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_pair_binary_seed2_moltrans.pt