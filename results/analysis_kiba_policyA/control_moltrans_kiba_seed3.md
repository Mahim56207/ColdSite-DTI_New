# Kinase confound control — moltrans, kiba, seed 3
...
|---|---|---|---|---|---|
| random | 0.022 | 0.020 | +0.002 | 211 | 60 |
| cold_drug | 0.016 | 0.017 | -0.001 | 212 | 60 |
...
- `cold_target` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_target_binary_seed3_moltrans.pt
- `cold_pair` — no checkpoint at /Users/mahimagarwal/ColdSite-results/kiba_binary/coldsite_dti_kiba_cold_pair_binary_seed3_moltrans.pt