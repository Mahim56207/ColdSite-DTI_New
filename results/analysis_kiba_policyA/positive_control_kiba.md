...
|---|---|---|---|
| hyperattentiondti_seed1 | random | 0.017 | at or below chance |
| hyperattentiondti_seed1 | cold_drug | 0.019 | at or below chance |
| hyperattentiondti_seed2 | random | 0.022 | at or below chance |
| hyperattentiondti_seed2 | cold_drug | 0.020 | at or below chance |
| hyperattentiondti_seed3 | random | 0.053 | 0.024 |
| hyperattentiondti_seed3 | cold_drug | 0.025 | 0.004 |
| moltrans_seed1 | random | 0.020 | at or below chance |
| moltrans_seed1 | cold_drug | 0.028 | 0.007 |
| moltrans_seed2 | random | 0.053 | 0.024 |
| moltrans_seed2 | cold_drug | 0.063 | 0.036 |
| moltrans_seed3 | random | 0.022 | at or below chance |
| moltrans_seed3 | cold_drug | 0.017 | at or below chance |
